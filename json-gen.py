...
def main():
    model = "polished_blackstone_brick_wall_"
    ...
    for model_suffix in model_suffixes:
        ...
        #)
        model_data = generate_model_textures_template(parent_model_id, "minecraft:template/texture/polished_blackstone_brick_wall");
